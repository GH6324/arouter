...
func ensureColumns(db *gorm.DB) {
	...
	cols := []col{
		...
		{&Node{}, "geo_ip", "nodes", "TEXT"},
		{&Node{}, "geo_lat", "nodes", "DOUBLE"},
		{&Node{}, "geo_lng", "nodes", "DOUBLE"},
		{&Node{}, "geo_city", "nodes", "TEXT"},
		{&Node{}, "geo_region", "nodes", "TEXT"},
		{&Node{}, "geo_country", "nodes", "TEXT"},
		{&Node{}, "geo_org", "nodes", "TEXT"},
		{&Node{}, "geo_updated_at", "nodes", "BIGINT"},
